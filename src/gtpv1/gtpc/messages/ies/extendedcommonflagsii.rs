...
impl Default for ExtendedCommonFlagsII {
    fn default() -> Self {
        ExtendedCommonFlagsII { t: EXTCOMMONFLAGS_II, length:EXTCOMMONFLAGS_II_LENGTH, pnsi:false, dtci:false, pmtsmi:false}
    }
}
...
fn extcommonflagsii_ie_marshal_test () {
    ...
    let ie_to_marshal = ExtendedCommonFlagsII { t:EXTCOMMONFLAGS_II, length: EXTCOMMONFLAGS_II_LENGTH, pnsi:true, dtci:true, pmtsmi:false };
...
fn extcommonflagsii_ie_unmarshal_test () {
    ...
    let ie_unmarshalled = ExtendedCommonFlagsII { t:EXTCOMMONFLAGS_II, length: EXTCOMMONFLAGS_II_LENGTH, pnsi:true, dtci:true, pmtsmi:false };
    assert_eq!(ExtendedCommonFlagsII::unmarshal(&ie_to_unmarshal).unwrap(), ie_unmarshalled);
}