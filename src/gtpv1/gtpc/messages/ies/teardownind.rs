...
impl Default for TeardownInd {
    fn default() -> TeardownInd {
        TeardownInd { t: TEARDOWN_IND, teardown:true }        
    }
}
...
fn teardown_ind_ie_unmarshal_test () {
    ...
    let test_struct = TeardownInd { t:TEARDOWN_IND, teardown: true };
...
fn teardown_ind_ie_marshal_test () {
    ...
    let test_struct = TeardownInd { t:TEARDOWN_IND, teardown: false };
