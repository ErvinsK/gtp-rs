...
impl Default for MSInfoChangeReportingAction {
    fn default() -> MSInfoChangeReportingAction {
        MSInfoChangeReportingAction { t: MSINFO_CHANGE, length:MSINFO_CHANGE_LENGTH, action:0 }        
    }
}
...
fn ms_info_change_ie_unmarshal_test () {
    ...
    let test_struct = MSInfoChangeReportingAction { t:MSINFO_CHANGE, length: MSINFO_CHANGE_LENGTH, action: 1 };
