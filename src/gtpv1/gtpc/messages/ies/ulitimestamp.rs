...
impl Default for UliTimestamp {
    fn default() -> UliTimestamp {
        UliTimestamp { t: ULI_TIMESTAMP, length:ULI_TIMESTAMP_LENGTH, timestamp:0 }        
    }
}
...
fn uli_timestamp_ie_unmarshal_test () {
    ...
    let test_struct = UliTimestamp { t:ULI_TIMESTAMP, length: ULI_TIMESTAMP_LENGTH, timestamp: 4000000000 };
