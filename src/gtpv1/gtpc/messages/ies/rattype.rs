...
impl Default for RatType {
    fn default() -> Self {
        RatType { t: RATTYPE, length:RATTYPE_LENGTH, rat_type:Rat::Geran}
    }
}
...
impl IEs for RatType {
    fn marshal (&self, buffer: &mut Vec<u8>) {
        ...
        buffer.push(Rat::enum_to_value(&self.rat_type));
...
fn rattype_ie_marshal_test () {
    ...
    let ie_to_marshal = RatType { t:RATTYPE, length: RATTYPE_LENGTH, rat_type:Rat::Geran };
...
fn rattype_ie_unmarshal_test () {
    ...
    let ie_unmarshalled = RatType { t:RATTYPE, length: RATTYPE_LENGTH, rat_type:Rat::Geran };
