...
fn update_pdp_ctx_resp_ggsn_unmarshal_test() {
    ...
    let encoded:[u8;59]= [
        0x32, 0x13, 0x00, 0x33, 0x37, 0x38, 0xbf, 0x7a,
        0x9b, 0xcf, 0x00, 0x00, 0x01, 0x80, 0x0e, 0x05,
        0x10, 0xa6, 0x97, 0x49, 0xf4, 0x85, 0x00, 0x04,
        0x3e, 0x99, 0x89, 0x60, 0x87, 0x00, 0x0c, 0x03,
        0x13, 0x83, 0x1f, 0x71, 0x96, 0x87, 0x87, 0x74,
        0xfa, 0xff, 0xff, 0x98, 0x00, 0x08, 0x01, 0x22,
        0xf6, 0x01, 0x06, 0x54, 0x3c, 0xa9, 0x99, 0x00,
        0x02, 0x80, 0x00
        ];
    let decoded = UpdatePDPContextResponseGGSN { 
        header: Gtpv1Header { msgtype: 19, length: 51, teid: 926465914, sequence_number: Some(39887), npdu_number: None, extension_headers: None }, 
        cause: Cause { t: 1, value: 128 }, 
        recovery: Some(Recovery { t: 14, value: 5 }), 
        teid_data: Some(Teid { t: 16, teid: 2794932724 }),  
        pco: None, 
        sgsn_ip_user: Some(GsnAddress { t: 133, length: 4, ip: IpAddr::V4(Ipv4Addr::new(62,153,137,96)) }), 
        ...
        apn_ambr: None, 
        private_extension: None };
    assert_eq!(UpdatePDPContextResponseGGSN::unmarshal(&encoded).unwrap(),decoded);
}
...
fn update_pdp_ctx_resp_ggsn_wrong_ie_order_unmarshal_test() {
    let encoded:[u8;59]= [
        0x32, 0x13, 0x00, 0x33, 0x37, 0x38, 0xbf, 0x7a,
        0x9b, 0xcf, 0x00, 0x00, 0x0e, 0x05, 0x01, 0x80,
        0x10, 0xa6, 0x97, 0x49, 0xf4, 0x85, 0x00, 0x04,
        0x3e, 0x99, 0x89, 0x60, 0x87, 0x00, 0x0c, 0x03,
        0x13, 0x83, 0x1f, 0x71, 0x96, 0x87, 0x87, 0x74,
        0xfa, 0xff, 0xff, 0x98, 0x00, 0x08, 0x01, 0x22,
    ...
    assert_eq!(UpdatePDPContextResponseGGSN::unmarshal(&encoded),Err(GTPV1Error::MessageInvalidMessageFormat));
}

#[test]
fn update_pdp_ctx_resp_ggsn_missing_mandatory_ie_unmarshal_test() {
    let encoded:[u8;57]= [
        0x32, 0x13, 0x00, 0x31, 0x37, 0x38, 0xbf, 0x7a,
        0x9b, 0xcf, 0x00, 0x00, 0x0e, 0x05,
        0x10, 0xa6, 0x97, 0x49, 0xf4, 0x85, 0x00, 0x04,
        0x3e, 0x99, 0x89, 0x60, 0x87, 0x00, 0x0c, 0x03,
        0x13, 0x83, 0x1f, 0x71, 0x96, 0x87, 0x87, 0x74,
        0xfa, 0xff, 0xff, 0x98, 0x00, 0x08, 0x01, 0x22,
    ...
    assert_eq!(UpdatePDPContextResponseGGSN::unmarshal(&encoded),Err(GTPV1Error::MessageMandatoryIEMissing));
}