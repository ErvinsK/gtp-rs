...
fn pdu_notification_reject_req_unmarshal_test() {
    ...
    let encoded:[u8;44]= [
        0x32,0x1d,0x0,0x24,0x37,0x38,0xbf,0x7a,
        0x9b,0xcf,0x0,0x0,0x1,0x5,0x11,0xa6,
        0x97,0x49,0xf4,0x80,0x0,0x6,0xf1,0x21,
        0xa,0xdb,0x3b,0x30,0x83,0x0,0xd,0x3,
        0x69,0x6f,0x74,0x4,0x31,0x6e,0x63,0x65,
        0x3,0x6e,0x65,0x74
    ];
    let decoded = PDUNotificationRejectRequest { 
        header: Gtpv1Header { msgtype: PDU_NOTIFICATION_REJECT_REQUEST, length: 36, teid: 926465914, sequence_number: Some(39887), npdu_number: None, extension_headers: None }, 
    ...
    assert_eq!(PDUNotificationRejectRequest::unmarshal(&encoded).unwrap(),decoded);
}
...
fn pdu_notification_reject_req_wrong_ie_order_unmarshal_test() {
    let encoded:[u8;44]= [
        0x32,0x1d,0x0,0x24,0x37,0x38,0xbf,0x7a,
        0x9b,0xcf,0x0,0x0,0x11,0xa6,
        0x97,0x49,0xf4,0x1,0x5,0x80,0x0,0x6,0xf1,0x21,
        0xa,0xdb,0x3b,0x30,0x83,0x0,0xd,0x3,
        0x69,0x6f,0x74,0x4,0x31,0x6e,0x63,0x65,
        0x3,0x6e,0x65,0x74
    ];
    assert_eq!(PDUNotificationRejectRequest::unmarshal(&encoded),Err(GTPV1Error::MessageInvalidMessageFormat));
}

#[test]
fn pdu_notification_reject_req_missing_mandatory_ie_unmarshal_test() {
    let encoded:[u8;42]= [
        0x32,0x1d,0x0,0x22,0x37,0x38,0xbf,0x7a,
        0x9b,0xcf,0x0,0x0,0x11,0xa6,
        0x97,0x49,0xf4,0x80,0x0,0x6,0xf1,0x21,
        0xa,0xdb,0x3b,0x30,0x83,0x0,0xd,0x3,
        0x69,0x6f,0x74,0x4,0x31,0x6e,0x63,0x65,
    ...
    assert_eq!(PDUNotificationRejectRequest::unmarshal(&encoded),Err(GTPV1Error::MessageMandatoryIEMissing));
}