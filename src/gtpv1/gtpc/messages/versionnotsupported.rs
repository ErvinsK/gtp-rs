...
fn test_version_not_supported_unmarshal () {
    let encoded:[u8;12] = [0x32, 0x03, 0x00, 0x04, 0x00, 0x00, 0x00, 0x00, 0x49, 0xca, 0x00, 0x00];
    let decoded:VersionNotSupported = VersionNotSupported { header: Gtpv1Header {msgtype:VERSION_NOT_SUPPORTED, length:4, teid:0, sequence_number:Some(18890), npdu_number: None, extension_headers:None}};
