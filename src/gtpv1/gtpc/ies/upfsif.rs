...
impl Default for UpFunctionSelectionIndicationFlags {
    fn default() -> UpFunctionSelectionIndicationFlags {
        UpFunctionSelectionIndicationFlags { t: UPFSIF, length:UPFSIF_LENGTH, dcnr:false }        
    }
}
...
fn upfsif_ie_unmarshal_test () {
    ...
    let test_struct = UpFunctionSelectionIndicationFlags { t:UPFSIF, length: UPFSIF_LENGTH, dcnr: true };
