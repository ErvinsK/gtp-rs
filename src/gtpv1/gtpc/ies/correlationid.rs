...
impl Default for CorrelationId {
    fn default() -> CorrelationId {
        CorrelationId { t: CORRELATIONID, length:CORRELATIONID_LENGTH, correlation_id:0 }        
    }
}
...
impl IEs for CorrelationId {
    fn marshal (&self, buffer: &mut Vec<u8>) {
        ...
        buffer.push(self.correlation_id);
...
fn correlationid_ie_unmarshal_test () {
    ...
    let test_struct = CorrelationId { t:CORRELATIONID, length: CORRELATIONID_LENGTH, correlation_id: 0xff };
