...
pub trait Messages {
    ...
    fn unmarshal (header:GtpuHeader, buffer:&[u8]) -> Result<Self, GTPV1Error> where Self:Sized;
    //fn len (&self) -> usize;
}
...
impl Messages for EchoRequest {
    ...
    fn unmarshal (header: GtpuHeader, buffer: &[u8]) -> Result<EchoRequest, GTPV1Error> {
...
impl Messages for EchoResponse {
    ...
    fn unmarshal(header: GtpuHeader, buffer: &[u8]) -> Result<EchoResponse, GTPV1Error> {
...
impl Messages for SupportedExtensionHeadersNotification {
    ...
    fn unmarshal(header: GtpuHeader, buffer: &[u8]) -> Result<SupportedExtensionHeadersNotification, GTPV1Error> {
