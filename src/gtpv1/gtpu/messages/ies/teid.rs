// TEID IE - according to 3GPP TS 29.281 V16.0.0 (2019-12)
...
fn teid_ie_unmarshal_test() {
    let ie_to_unmarshal:[u8;5] = [0x10, 0x63, 0x41, 0xaf, 0xd7];
    let ie_unmarshalled = Teid { t: TEID_DATA, teid: 0x6341afd7};
