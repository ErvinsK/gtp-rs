        ...
        impl NextExtensionHeaderField {
            ...
            pub fn len (&self) -> usize {
                ...
                match *self {
                    ...
                    NextExtensionHeaderField::LongPDCPPDUNumber(LongPDCPPDUNumber{length, ..}) => size(length),
                    NextExtensionHeaderField::ServiceClassIndicator(ServiceClassIndicator{length, ..}) => size(length),
                    NextExtensionHeaderField::UDPPort(UDPPort{length, ..}) => size(length),
                    NextExtensionHeaderField::RANContainer(RANContainer{length, ..}) => size(length),
                    NextExtensionHeaderField::XwRANContainer(XwRANContainer{length, ..}) => size(length),
                    NextExtensionHeaderField::NRRANContainer(NRRANContainer{length, ..}) => size(length),
                    NextExtensionHeaderField::PDUSessionContainer(PDUSessionContainer{length, ..}) => size(length),
