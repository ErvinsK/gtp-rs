...
impl IEs for ApnRelativeCapacity {
    ...
    fn unmarshal (buffer:&[u8]) -> Result<Self, GTPV2Error> {
        if buffer.len()>=MIN_IE_SIZE {
            let mut data=ApnRelativeCapacity::default();
...
fn apn_rel_cap_ie_marshal_test () {
    let encoded:[u8;18]=[0xb8, 0x00, 0x0e, 0x00, 0x64, 0x04, 0x74, 0x65, 0x73, 0x74, 0x03, 0x6e, 0x65, 0x74, 0x03, 0x63, 0x6f, 0x6d];
    let decoded = ApnRelativeCapacity { t:APN_REL_CAP, length: 14, ins:0, relative_cap: 100, name: "test.net.com".to_string() };
