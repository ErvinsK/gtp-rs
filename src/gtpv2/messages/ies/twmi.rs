// Trusted WLAN Mode Indication (TWMI) IE - according to 3GPP TS 29.274 V15.9.0 (2019-09)
...
impl Default for Twmi {
    fn default() -> Self {
        Twmi { t: TWMI, length:TWMI_LENGTH as u16, ins:0, mcm:false, scm:false }        
    }
}
...
fn twmi_ie_unmarshal_test () {
    ...
    let decoded = Twmi { t:TWMI, length: TWMI_LENGTH as u16, ins:0, mcm: true, scm:false };
