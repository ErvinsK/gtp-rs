// MBMS IP Multicast Distribution IE - according to 3GPP TS 29.247 V15.9.0 (2019-09)
...
fn mbmsipmulticastdistr_ie_marshal_test() {
    let encoded: [u8; 31] = [
        0x8E,        0x00,        0x1B,        0x00,        0x00,        0x00,        0xFF,        0xFF,
        0x04,        0x0A,        0x0A,        0x0A,        0x01,        0x50,        0x00,        0xFD,
