// Load Control IE (Grouped IE) - according to 3GPP TS 29.274 V15.9.0 (2019-09)
...
fn load_control_ie_unmarshal_test () {
    let encoded:[u8;35]=[
        ...
        0xb8, 0x00, 0x0e, 0x00, 0x64, 0x04, 0x74, 0x65, 0x73, 0x74, 0x03, 0x6e, 0x65, 0x74, 0x03, 0x63, 0x6f, 0x6d,   
    ];
