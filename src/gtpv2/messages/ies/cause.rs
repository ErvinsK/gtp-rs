...
fn cause_ie_short_marshal_test() {
    let decoded=Cause{ t: CAUSE, length: 2, ins:0, value:16, pce:false, bce:false, cs:false, offend_ie_type:None};
...
fn cause_ie_long_marshal_test() {
    let decoded=Cause{ t: CAUSE, length: 6, ins:0, value:16, pce:false, bce:true, cs:false, offend_ie_type:Some(0x0f)};
