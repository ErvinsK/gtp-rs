// MM Context EPS Security Context and Quadruplets IE - according to 3GPP TS 29.274 V15.9.0 (2019-09)
...
impl IEs for MmContextEpsSecurityContextQuadruplets {
    fn marshal(&self, buffer: &mut Vec<u8>) {
        ...
        buffer_ie.push(self.ins);
        {
            ...
            if self.next_hop.is_some() { byte |=  0x10 };
            if self.drx_params.is_some() { byte |=  0x08 };
            byte |= self.ksi & 0x07;
            buffer_ie.push(byte);
        }
        {
        ...
        }
        {
            let byte :u8 = if self.subscr_ue_ambr.is_some() {
                0x80 | (u8::from(self.nas_integrity.clone())) << 4 | u8::from(self.nas_cipher.clone())
            } else {
...
fn mmctxepssecctxq_ie_marshal_test() {
    let ie_marshalled: [u8; 385] =  [
        0x6b,        0x01,        0x7d,        0x00,        0x98,        0x27,        0x81,        0x27,
        ...
        0x0c,        0x0d,        0x0e,        0x0f,        0x10,        0x03,        0x02,        0x07,
        0x08,        0x03,        0x03,        0x09,        0x0a,        0x0b,        0x0c,        0x0d,
        ...
        0x08,        0x09,        0x0a,        0x0b,        0x0c,        0x0d,        0x0e,        0x0f,
        0x10,        0x03,        0x03,        0x09,        0x0a,        0x01,        0x02,        0xaa,
        0xaa,        0xaa,        0xaa,        0xaa,        0xaa,        0xaa,        0xaa,        0xaa,
        0xaa,        0xaa,        0xaa,        0xaa,        0xaa,        0xaa,        0xaa,        0xaa,
        0xaa,        0xaa,        0xaa,        0xaa,        0xaa,        0xaa,        0xaa,        0xaa,
        0xaa,        0xaa,        0xaa,        0xaa,        0xaa,        0xaa,        0xaa,        0x05,
        0x00,        0x00,        0x07,        0xd0,        0x00,        0x00,        0x1f,        0x40,
        0x00,        0x00,        0x07,        0xd0,        0x00,        0x00,        0x1f,        0x40,
        0x04,        0x01,        0x02,        0x03,        0x04,        0x04,        0x01,        0x02,
        0x03,        0x04,        0x04,        0x01,        0x02,        0x03,        0x04,        0x00,
        ...
        0xff,        0xff,        0xff,        0xff,        0xff,        0xff,        0xff,        0xff,
        0xff,        0xff,        0xff,        0xff,        0xff,        0xff,        0xff,        0xff,
        0xff,        0x04,        0x01,        0x02,        0x03,        0x04,        0x04,        0x01,
        0x02,        0x03,        0x04,        0x01,        0x03,        0x04,        0x01,        0x02,
        0x03,        0x04,        0x04,        0x01,        0x02,        0x03,        0x04,        0x02,
        0x00,        0x22,        0x00,        0x0c,        0x74,        0x65,        0x73,        0x74,
        0x2e,        0x61,        0x70,        0x6e,        0x2e,        0x63,        0x6f,        0x6d,
        0x12,        0x34,        0x56,        0x78,        0x12,        0x34,        0x56,        0x78,
        0x12,        0x34,        0x56,        0x78,        0x01,        0x02,        0x03,        0x04,
        0x05,        0x06,        0x07,        0x08,        0x00,        0x23,        0x00,        0x0d,
        0x74,        0x65,        0x73,        0x74,        0x32,        0x2e,        0x61,        0x70,
        0x6e,        0x2e,        0x63,        0x6f,        0x6d,        0x12,        0x34,        0x56,
        0x78,        0x12,        0x34,        0x56,        0x78,        0x12,        0x34,        0x56,
        0x78,        0x01,        0x02,        0x03,        0x04,        0x05,        0x06,        0x07,
        0x08,
    ];
    let ie_to_marshal = MmContextEpsSecurityContextQuadruplets {
        ...
        apn_rate_controls: Some(vec![ApnRateControlStatusMM {
