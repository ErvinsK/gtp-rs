// Allocation/Retention Priority (ARP) IE - according to 3GPP TS 29.274 V15.5.0 (2019-09)
...
impl Default for Arp {
    fn default() -> Arp {
        Arp { t: ARP, length:ARP_LENGTH as u16, ins:0, pci:false, pl:0, pvi:false }        
    }
}
...
fn arp_ie_unmarshal_test () {
    ...
    let decoded = Arp { t:ARP, length: ARP_LENGTH as u16, ins:0, pci: true, pl:5, pvi:false };
