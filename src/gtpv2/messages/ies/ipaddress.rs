...
fn ip_address_ie_ipv4_unmarshal_test () {
    ...
    let test_struct = IpAddress { t:IP_ADDRESS, length:4, ins:0, ip:IpAddr::V4(Ipv4Addr::new(0,0,0,0)) };
...
fn ip_address_ie_ipv6_unmarshal_test () {
    ...
    let encoded_ie:[u8;20]=[0x4a, 0x00, 0x10, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00];
    let test_struct = IpAddress { t:IP_ADDRESS, length:16, ins:0, ip:IpAddr::V6(Ipv6Addr::new(0,0,0,0,0,0,0,0)) };
    let i = IpAddress::unmarshal(&encoded_ie);
    assert_eq!(i.unwrap(), test_struct);
}
