...
fn msisdn_ie_unmarshal_test () {
    let encoded_ie:[u8;12]=[0x4c, 0x00, 0x08, 0x00, 0x88, 0x22, 0x58, 0x01, 0x10, 0x52, 0x11, 0xf2];
    let test_struct = Msisdn { t:MSISDN, length: 8, ins:0, msisdn:"882285100125112".to_string(), };
