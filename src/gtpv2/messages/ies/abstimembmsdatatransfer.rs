// Absolute Time of MBMS Data Transfer IE - according to 3GPP TS 29.274 V15.9.0 (2019-09)
...
fn abstime_mbmsdatatransfer_ie_marshal_test() {
    let encoded: [u8; 12] = [0xa3, 0x00, 0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xff, 0xff];
