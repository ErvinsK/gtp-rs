...
impl Messages for ReleaseAccessBearersRequest {
    ...
    fn tovec(&self) -> Vec<InformationElement> {
        ...
        self.list_rabs.iter().for_each(|x| {
            elements.push(InformationElement::Ebi(x.clone()))
        });
...
fn test_release_access_bearers_req_unmarshal() {
    let encoded: [u8; 79] = [
        0x48, 0xaa, 0x00, 0x4b, 0xe6, 0x4d, 0xa4, 0xef,
        0x26, 0x00, 0x2e, 0x00, 0x49, 0x00, 0x01, 0x00,
        0x05, 0x49, 0x00, 0x01, 0x00, 0x06, 0x87, 0x00, 
        0x01, 0x00, 0x00, 0x4d, 0x00, 0x07, 0x00, 0x00, 
        0x00, 0x00, 0x40, 0x00, 0x00, 0x00, 0xc9, 0x00, 
        0x1b, 0x00, 0x03, 0x00, 0x05, 0x00, 0x00, 0x00, 
        0xff, 0x00, 0x00, 0xff, 0xff, 0x00, 0x00, 0x00, 
        0x00, 0xff, 0xff, 0xff, 0x00, 0x00, 0x00, 0x00, 
        0x00, 0x00, 0x00, 0xff, 0xff, 0xff, 0x00, 0x06, 
